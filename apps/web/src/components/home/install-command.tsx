...
//   · 首页 hero：默认命令 `dsh plugin --profile web add deepc-link@latest`
...
const DEFAULT_COMMAND = "dsh plugin --profile web add deepc-link@latest"

interface InstallCommandProps {
  /** 要复制的命令（默认 `dsh plugin --profile web add deepc-link@latest`） */
  command?: string
