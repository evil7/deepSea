/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2a78e99838d661e5c6e0839fe840396)
// Runtime types generated with workerd@1.20260825.1 2025-08-04 nodejs_compat
interface __BaseEnv_Env {
	...
	DEEPSEA_BASE: string;
	TUNNEL_HUB: DurableObjectNamespace<import("./src/index").TunnelHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TunnelHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OAUTH_AUTHORIZE" | "GITHUB_OAUTH_SCOPE" | "SESSION_TTL_SECONDS" | "STATE_TTL_SECONDS" | "TOKEN_TTL_SECONDS" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "TOKEN_ENC_KEY" | "DEEPSEA_BASE">> {}
}
